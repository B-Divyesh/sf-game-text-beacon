...
function shell(content: string, title: string, description: string) {
  ...
  app.innerHTML = `<a class="skip" href="#main">Skip to content</a>
    ...
    <footer><p>Read game text aloud from a chosen region.</p><p><a href="/privacy" data-link>Privacy</a> · <a href="/terms" data-link>Terms</a> · Built by Param Factory · v0.1.2</p><p class="tiny">Notebook art is original generated product art.</p></footer>`
